...
namespace fire_ash_server.Props.Items.Weapons
{
    internal class SpiderClaw : Weapon
    {
        ...
        {
            if (!GeneralAttackDescriptionsForType.ContainsKey(typeof(SpiderClaw)))
            {
                List<Func<string, string, Weapon, string>> descriptions = new List<Func<string, string, Weapon, string>>();

                descriptions.Add((a, r, w) => $"{a} thrusts their razor-sharp spider claw towards {r}.");
                descriptions.Add((a, r, w) => $"{a} swiftly lashes out at {r} with their spider claw, seeking to tear through.");
                ...
                descriptions.Add((a, r, w) => $"{a} leaps at {r}, trying to stab their spider claw into the target.");
                ...
                descriptions.Add((a, r, w) => $"{a} lunges at {r}, attempting to pierce with the spider claw.");
                ...
                descriptions.Add((a, r, w) => $"{a} lunges and strikes at {r} with their spider claw.");
                descriptions.Add((a, r, w) => $"{a} strikes at {r} with their spider claw.");
                descriptions.Add((a, r, w) => $"{a} darts in, aiming to stab {r} with their sharp claw.");
                descriptions.Add((a, r, w) => $"{a} swiftly stabs at {r} with their spider claw.");
                ...
                descriptions.Add((a, r, w) => $"{a} strikes at {r} with a quick jab of their spider claw.");
                descriptions.Add((a, r, w) => $"{a} drives their claw towards {r} with a quick thrust.");
                descriptions.Add((a, r, w) => $"{a} slashes at {r} with their sharp spider claw.");
                descriptions.Add((a, r, w) => $"{a} leaps and strikes at {r} with their claw.");
                descriptions.Add((a, r, w) => $"{a} darts in with a quick stab at {r} with their spider claw.");

                GeneralAttackDescriptionsForType.Add(typeof(SpiderClaw), descriptions);
            }
        }

        public static void SetGeneralOffHandAttackDescriptionsForType()
        {
            if (!GeneralOffHandAttackDescriptionsForType.ContainsKey(typeof(SpiderClaw)))
            {
                ...
                GeneralOffHandAttackDescriptionsForType.Add(typeof(SpiderClaw), offhandDescriptions);
            }
        }

        public static void SetHumanoidAttackDescriptions()
        {
            if (!HumanoidAttackDescriptionsForType.ContainsKey(typeof(SpiderClaw)))
            {
                List<Func<string, string, Weapon, string>> descriptions = new List<Func<string, string, Weapon, string>>();
                ...
                HumanoidAttackDescriptionsForType.Add(typeof(SpiderClaw), descriptions);
            }
        }

        public static void SetHumanoidOffHandAttackDescriptions()
        {
            if (!HumanoidOffHandAttackDescriptionsForType.ContainsKey(typeof(SpiderClaw)))
            {
                List<Func<string, string, Weapon, string>> offhandDescriptions = new List<Func<string, string, Weapon, string>>();
                ...
                HumanoidOffHandAttackDescriptionsForType.Add(typeof(SpiderClaw), offhandDescriptions);
            }
        }
    }
}
