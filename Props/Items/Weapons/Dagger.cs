...
namespace fire_ash_server.Props.Items.Weapons
{
    ...
    {
        public Dagger(string name, string description) : base(name, description, new Die(1, 3), DamageType.Piercing)
        {
            ...
            SetAttackDescriptionsForType();
            SetOffHandAttackDescriptionsForType();
        }

        public static void SetAttackDescriptionsForType()
        {
            if (!AttackDescriptionsForType.ContainsKey(typeof(Dagger)))
            {
                ...
                AttackDescriptionsForType.Add(typeof(Dagger), descriptions);
            }
        }

        public static void SetOffHandAttackDescriptionsForType()
        {
            if (!OffHandAttackDescriptionsForType.ContainsKey(typeof(Dagger)))
            {
                ...
                OffHandAttackDescriptionsForType.Add(typeof(Dagger), offhandDescriptions);
            }
        }
    }
}
