    ...
    internal static class TempleTrinketList
    {
        public static Item GetRandom()
        {
            ...
            List<Item> trinkets = new List<Item>{
                ...
                new Item("Ancient Coin", "A coin from a long-forgotten civilization. Its surface is worn, but faint engravings of an unknown language can still be seen.", 2.0),
                new Item("Glimmering Pebble", "A small, smooth pebble that shines with a light of its own. Its surface feels warm to the touch.", 0.5),
                ...
                new Item("Mechanical Insect", "A tiny clockwork insect, motionless. Its gears and tiny legs are intricately designed, hinting at a lost art of miniaturization.", 7.0),
                ...
                new Item("Old Compass", "A brass compass with a cracked glass face. Despite its age, the needle still points true.", 2.0),
                new Item("Tiny Music Box", "A diminutive music box that plays a haunting melody when opened. Its mechanism seems impossibly small.", 10.0)};
