...
namespace fire_ash_server.World.BioMechWorld.MainHall
{
    internal class Elara
    {
        public static Character Create()
        {
            ...
            DialogueNode elaraStartNode = new DialogueNode("There you are. I am Elara, the Defender of this enclave. Time is against us, and I have no one else to spare. I need your help.");
            ...
            DialogueNode elaraSeekVexisNode = new DialogueNode("To find these tunnels, you must seek out Vexis, the caretaker. Vexis knows the way into these ancient passages. Find him in the Caretaker's Chamber. When you locate the tunnels, you'll need to clear them for safe passage and scout the enemy's positions.");
            ...
            elaraTheDefender.CreateDialogueManager(elaraStartNode);
